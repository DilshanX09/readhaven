...
/*
     stage 1 -> keyword set and is stock true , [done]
     stage 2 -> category set and is stock true , [done]
     stage 3 -> only stock true , [done]
     stage 4 -> keyword , category set and is stock true ,
*/
...
?>
     <div class="col-6  col-md-4 col-xl-3  py-2 d-flex flex-column">
          ...
          <div class="row product_img position-relative">
               ...
               <span <?php if ($selected_books_data['qty'] > 0) { ?> onclick="book_add_cart(<?= $selected_books_data['book_id'] ?> , <?= $selected_books_data['qty']; ?>);" <?php } ?> style="position: absolute;top: 25px;right: 35px;" class="bg-white cart-icon">
                    <i class="bi bi-bag"></i>
               </span>
